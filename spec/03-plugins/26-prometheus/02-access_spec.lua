...
describe("Plugin: prometheus (access)", function()
  ...
  it("increments the count for proxied requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_request_count{service="mock-service",route="http-route",code="400",source="upstream",consumer=""} 1', nil, true)
    end)
  end)
  ...
  it("increments the count for proxied TCP streams", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_stream_status{service="tcp-service",route="tcp-route",code="200",source="upstream",consumer=""} 1', nil, true)
    end)
...
describe("Plugin: prometheus (access) per-consumer metrics", function()
  ...
  it("increments the count for proxied requests", function()
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_request_count{service="mock-service",route="http-route",code="200",source="upstream",consumer="alice"} 1', nil, true)
    end)
    ...
    helpers.wait_until(function()
      ...
      return body:find('kong_request_count{service="mock-service",route="http-route",code="400",source="upstream",consumer="alice"} 1', nil, true)
    end)
  end)
  ...
  it("behave correctly if consumer is not found", function()
    ...
    assert.matches('kong_request_count{service="mock-service",route="http-route",code="401",source="kong",consumer=""} 1', body, nil, true)
